...
Download the trained model weights from [[HDETrack_S_ep0050.pth](https://pan.baidu.com/s/1OQRn9bDxgzx1IVhrbVar0g?pwd=wsad )] and put it under `$/output/checkpoints/train/hdetrack` for test directly.
