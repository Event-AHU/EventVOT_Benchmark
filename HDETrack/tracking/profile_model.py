...
import argparse
import torch
from lib_clip.utils.misc import NestedTensor
...
def parse_args():
    ...
    # for train
    parser.add_argument('--script', type=str, default='hdetrack', choices=['hdetrack'],
                        help='training script name')
    parser.add_argument('--config', type=str, default='hdetrack_coesot', help='yaml configure file name')
...
if __name__ == "__main__":
    ...
    if args.script == "hdetrack":
        model_module = importlib.import_module('lib.models')
        model_constructor = model_module.build_hdetrack
