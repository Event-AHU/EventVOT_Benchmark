...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='eventvot', help='eventvot or coesot or fe108 or visevent or eed.')
    parser.add_argument('--parameter_name', type=str, default='hdetrack_coesot', help='eventvot or coesot or fe108 or visevent or eed.')
    ...
    """hdetrack"""
    trackers.extend(trackerlist(name='hdetrack', parameter_name=args.parameter_name, dataset_name=dataset_name,
                                run_ids=None, display_name='HDETrack256'))
